# Organic Polymer Energy Conversion Materials (OPECM) Dataset
...
<img width="1090" height="690" alt="image" src="https://github.com/user-attachments/assets/7a90da0d-cd2d-4300-8c23-e37c24779e67" />


When using this database in your research PLEASE cite the papers:  
[1] Xiumin Liu, Xinyue Zhang, Yabei Wu, Xuehai Ju, Caichao Ye*, Wenqing Zhang*. OPECM: A comprehensive dataset for organic polymer energy conversion materials enabling data-driven interpretative analysis. Phys. Rev. Mater., 2025, DOI:10.1103/tqfw-w29l.  
